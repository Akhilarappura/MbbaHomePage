      ...
      <div className='content-wrapper'>
        ...
        <div className="text-section">
          ...
          <h2 className="description">
            ...
            IEC have partnered with many renowned Medical Universities Internationally and always act as a link between the Universities and the students. At IEC we not only nurture good doctors but also doctor with a strong and comprehensive foundation of Medical Knowledge, Skills and Compassion. We train them to be the leaders, to make independent decisions and to collaborate with other medical professionals.
