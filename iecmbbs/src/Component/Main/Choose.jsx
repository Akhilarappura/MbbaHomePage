  ...
  return (
    <div className='main'>
      <div className='choose-1'>
        ...
        <p>+ India’s most trusted overseas education consultancy with a proven track record.</p>
        <p>+ Expert counselors guiding you to achieve your academic dreams.</p>
        <p>+ Partnerships with top global universities offering diverse opportunities.</p>
        <p>+ Comprehensive support—from course selection to visa assistance.</p>
        <p>+ Assistance with scholarships and funding options to make education affordable.</p>
